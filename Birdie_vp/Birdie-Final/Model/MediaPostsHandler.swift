...
class MediaPostsHandler: NSObject {
    ...
    func getPosts() {
        ...
        let imagePost2 = ImagePost(textBody: "Went to the Aquarium today :]\nI was really thinking about code", userName: "Audrey", timestamp: Date(timeIntervalSince1970: 30000), image: UIImage(named: "octopus")!)
        let textPost1 = TextPost(textBody: "Hello World!\nI love breaking code!", userName: "Bhagat", timestamp: Date(timeIntervalSince1970: 20000))
